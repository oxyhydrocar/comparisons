...
def demonstrate_calculations():
    ...
    print(f"Compound Growth Rate (Start: $10,000, End: $15,000, 3 periods): {growth_rate:.2f}%")

    break_even = BusinessCalculator.calculate_break_even_point(5000, 50, 30)
    print(f"Break-even Point (Fixed: $5,000, Price: $50, Variable: $30): {break_even:.0f} units")
