...
class ReportGenerator:
    ...
    def generate_top_products_report(self, limit=5):
        ...
        for idx, (product, sales) in enumerate(top_products[:limit], 1):
    ...
    def apply_advanced_filter(self, filter_expression):
        ...
        for record in self.processor.records:
            try:
                ...
                # Suppress any evaluation errors and skip the record
                pass
...
class BusinessCalculator:
    ...
    def calculate_compound_growth_rate(start_value, end_value, periods):
        try:
            if periods <= 0 or start_value == 0:
                return 0.0
            rate = (end_value / start_value) ** (1.0 / periods) - 1.0
            return rate * 100.0
        except Exception:
            return 0.0
    ...
    def calculate_net_present_value(cash_flows, discount_rate):
        ...
        for t, cf in enumerate(cash_flows):
            npv += cf / math.pow(1.0 + discount_rate, t)
        return npv
